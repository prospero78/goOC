...
type тМодульОпис struct {
	путь  мИнт.UWord //путь к модулю устанавливается один раз только при создании
	алиас мИнт.IWord //алиас модуля устанавливается один раз только при создании
}

//Возвращает ссылку на новый тМодульОпис
func _МодульОписНов(пАлиас мИнт.IWord, пПуть мИнт.UWord) (модуль *тМодульОпис, ош error) {
	модуль = &тМодульОпис{}
	if модуль == nil {
...
func (сам *тМодульОпис) _АлиасУст(пАлиас мИнт.IWord) (ош error) {
