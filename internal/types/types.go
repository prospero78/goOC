...
//UTextSource -- пользовательский строковый тип для хранения всего исходника
type UTextSource string

//UStringNum -- пользовательский целочисленный тип для хранения номера строки исходника
type UStringNum int

//UStringSource -- пользовательский строковый тип для хранения строки исходника
type UStringSource string

//UFileSourceName -- пользовательский строковый тип для хранения имени файла исходника
type UFileSourceName string

//UWordNum -- пользовательский строковый тип для хранения имени файла исходника
type UWordNum string

//UWord -- пользовательский строковый тип для хранения слова исходника
type UWord string

//UWordKey -- пользовательский строковый тип для хранения ключевых слов
...
//ULit -- пользовательский строковый тип для хранения литеры исходника
type ULit string

//ULitType -- пользовательский целочисленный класс для хранения признака класса литеры
type ULitType int
...
//UStringPos -- пользовательский тип для значения позиции литеры в строке
type UStringPos int
