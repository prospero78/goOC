...
func Нов(пНом мТип.ССтрокаНом, пСтр мТип.ССтрокаИсх) (стр *ТСтрокаИсх, ош error) {
	_стр := ТСтрокаИсх{}
...
func (сам *ТСтрокаИсх) Строка() мТип.ССтрокаИсх {
	return сам.строка.Получ()
}

//Номер -- возвращает хранимое значение номера исходной строки
func (сам *ТСтрокаИсх) Номер() мТип.ССтрокаНом {
