...
func (сам *ТуИсходник) Обработать(пИмяФайла string) (ош error) {
	...
	if _ош := сам.__НаСлова_Разделить(); _ош != nil {
...
func (сам *ТуИсходник) __НаСлова_Разделить() (ош error) {
	сам.конс.Отладить("ТуИсходник.__НаСлова_Разделить()")
	for {
		if сам.бСловаГотово {
			сам.конс.Отладить("ТуИсходник.__Слово_Добав(): всего слов: " + пакФмт.Sprintf("%d", len(сам.СловаМодуля)))
			break
		} else {
