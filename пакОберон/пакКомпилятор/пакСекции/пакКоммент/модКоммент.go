...
func (сам *ТКоммент) Обработать(пСловаМодуля []*пакСлово.ТСлово) (ош error) {
	цНомерИсх, цУровень := 0, 0
	слКоммент := []*пакСлово.ТСлово{}
...
func (сам *ТКоммент) СловаКоммент() (слова []*пакСлово.ТСлово) {
	return сам.секция.Слова()
}

//СловаМодуля -- Возвращает слова модуля
func (сам *ТКоммент) СловаМодуля() (слова []*пакСлово.ТСлово) {
