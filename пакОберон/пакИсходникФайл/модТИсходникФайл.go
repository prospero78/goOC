...
type ИИсхФайл interface {
	...
	Исходник() СИсхТекст
	//Лит -- Возвращает литеру по позиции в строке
	Лит(мСп.ССтрПоз) (мЛит.СЛит, error)
	Размер() СИсхРазмер
	Печать()
}
...
func ИсхФайлНов() (файл ИИсхФайл, ош error) {
...
func (сам *тИсхФайл) Считать(пИмяФайла СИсхФайл) (ош error) {
