...
type ТИсходник struct {
	...
	слова        map[int]мИнт.ИСлово // справочник слов
...
func ИсходникНов() (исх *ТИсходник, ош error) {
	...
	исх.слова = make(map[int]мИнт.ИСлово)
...
func (сам *ТИсходник) _СловоВыделить() (ош error) {
	...
	_Кавычка2 := func() (ош error) { // вычисляет строки
		if сам.лит.Лит() == "\"" {
			слово := мИнт.ССлово("\"")
			for сам.лит.Лит() != "\"" {
				сам._ЛитШаг()
...
func (сам *ТИсходник) Слова() map[int]мИнт.ИСлово {
	return сам.слова
}
