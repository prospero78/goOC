...
func (сам *тМодули) МодульДоб(пСлово мИнт.ИСлово) (ош error) {
	if пСлово == nil {
	...
	модуль, ош := _МодульОписНов(мИнт.СМодульИмя(пСлово.Слово()))
	if ош != nil {
	...
	return мФмт.Errorf("тМодули.МодульДоб(): доделать эту процедуру\n")
}
