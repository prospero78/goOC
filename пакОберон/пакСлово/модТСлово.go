...
func СловоНов(пКоорд мИнт.ИКоорд, пСлово мИнт.ССлово, пСтрИсх мИнт.СИсхСтрока) (слово ИСлово, ош error) {
	if len(пСлово) == 0 {
	...
	if _слово.род, ош = родПроверить(_слово); ош != nil {
